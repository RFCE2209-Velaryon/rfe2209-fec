...
const CompareModal = (props) => {
  ...
  return (
    <div onClick={()=>props.onClick()} style={{backgroundColor: 'rgba(0,0,0,0.4)', position:'fixed', left: 0, top: 0, right: 0, bottom: 0, display: 'flex', alignItems: 'center', justifyContent: 'center'}} className='modalWrapper'>
